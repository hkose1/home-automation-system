    ...
    <main class="container d-flex align-items-center justify-content-center" style="margin-top: 7rem;">
        <div class="card card-bg" style="width: 30rem;">
            ...
            <div class="card-body">
                ...
                <?php elseif (session('username_validation_error')) : ?>
                    <div class="alert alert-danger"><?= session('username_validation_error') ?></div>

                <?php elseif (session('password_validation_error')) : ?>
                    <div class="alert alert-danger"><?= session('password_validation_error') ?></div>
                ...
                <form action="../controller/controller.php?req=signup" method="post">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="username" id="username" class="form-control" value="<?= session('username') ?>" placeholder="username">
                    </div>
                    ...
                    <div class="col-sm-9">
                        <input type="email" name="email" id="email" value="<?= session('email') ?>" class="form-control" placeholder="example@gmail.com">
                    </div>


                    <label for="phone" class="col-sm-3 col-form-label">Phone Number</label>
                    <div class="col-sm-9">
                        <input type="tel" name="phone" id="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" placeholder="xxx-xxx-xxxx" value="<?= session('phone') ?>">
                    </div>
...
$_SESSION['username_validation_error'] = null;
$_SESSION['succeessfully_signedup'] = null;
$_SESSION['password_validation_error'] = null;
